...
SQL – Data extraction and churn-related aggregations

SAS – Logistic regression modeling for churn prediction
...
An interactive dashboard was built to visualize churn patterns and customer behavior.

Dashboard Highlights:

Churn Rate by Support Call Frequency
...
Customers with three or more support calls exhibit significantly higher churn rates

Indicates unresolved service issues or poor customer experience
...
Retention improves and stabilizes as tenure increases
...
A logistic regression model was developed in SAS to estimate the probability of customer churn.
...
Frequent support interactions significantly increase churn risk

Monthly contract customers churn at higher rates than annual-plan customers

Premium customers demonstrate stronger retention
...
Implement early-warning churn flags for customers with multiple support calls

Improve onboarding and engagement within the first 90 days

Encourage annual contract upgrades through targeted incentives

Introduce retention offers before customers reach the six-month risk window
